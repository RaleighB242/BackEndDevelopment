...
?>
<center><h3>See all Teaching Assistants</h3></center>
	
    <table>
    
        <tr>
            <th width="150px">TA ID<br><hr></th>
            <th width="250px">TaFName<br><hr></th>
            <th width="250px">TaLName<br><hr></th>
            <th width="250px">TaPhone<br><hr></th>
...
<?php
$sql = mysqli_query($link, "SELECT * FROM TeachingAssistant");
