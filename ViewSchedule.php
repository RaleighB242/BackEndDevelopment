...
?>
<center><h3>See all the Teachers&TA's</h3></center>
<table>
    
    <tr>
        <th width="150px">Teachers ID<br><hr></th>
        <th width="250px">Teachers First Name<br><hr></th>
        <th width="250px">Teachers Last Name<br><hr></th>
        <th width="250px">Teaching Assistant ID<br><hr></th>
        <th width="150px">Teaching Assistant First Name <br><hr></th>
        <th width="150px">Teaching Assistant Last Name<br><hr></th>
    </tr>
    <?php
$sql = mysqli_query($link, "SELECT Schedule.TeachersID AS TeachersID, Teachers.Teachers_fname AS Teachers_fname, Teachers.Teachers_lname AS Teachers_lname, Schedule.TaID, TeachingAssistant.Ta_fname AS Ta_fname, TeachingAssistant.Ta_lname AS Ta_lname
FROM Schedule
INNER JOIN Teachers ON Schedule.TeachersID = Teachers.TeachersID
INNER JOIN TeachingAssistant ON Schedule.TaID = TeachingAssistant.TaID
");
