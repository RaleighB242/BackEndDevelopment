...
?>
<center><h3>See all Parents&Students</h3></center>
<table>
    
    <tr>
        <th width="150px">Parents ID<br><hr></th>
        <th width="250px">Parents First Name<br><hr></th>
        <th width="250px">Parents Last Name<br><hr></th>
        <th width="250px">Students ID<br><hr></th>
        <th width="150px">Students First Name <br><hr></th>
        <th width="150px">Students Last Name<br><hr></th>
    </tr>
    <?php
$sql = mysqli_query($link, "SELECT ChildrenHad.ParentsID AS ParentsID, Parents.parents_fname AS parents_fname, Parents.parents_lname AS parents_lname, ChildrenHad.StudentsID, Students.students_fname AS students_fname, Students.students_lname AS students_lname
FROM ChildrenHad
INNER JOIN Parents ON ChildrenHad.ParentsID = Parents.ParentsID
INNER JOIN Students ON ChildrenHad.StudentsID = Students.StudentsID
");
