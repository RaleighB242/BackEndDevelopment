...
if(isset($_POST['submit'])){
    ...
    $sql = "UPDATE Teachers SET Teachers_fname = '$tFname', Teachers_lname = '$tLname', Teachers_salary = '$tsalary',  Teachers_phonenumber = '$tphone', Teachers_backgroundcheck = '$tback', Teachers_address = '$taddress' , ClassesID = '$tClassID' WHERE TeachersID = '$tID' ";
