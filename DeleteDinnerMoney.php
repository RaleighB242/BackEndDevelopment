...
<body>
  ...
  <section class="container my-2 bg-dark w-50 text-light p-2 studentsform">
    <form class="row g-3 p-3" action="DeleteDinnerMoney.php" method="POST">
      <div class="col-12">
        <label for="DinnerMoneyID" class="form-label">DinnerMoney ID</label>
...
if(isset($_POST['submit'])){
    ...
    $sql = "DELETE FROM DinnerMoney WHERE DinnerMoneyID = '$dID' ";
