...
<section class="container my-2 bg-dark w-50 text-light p-2 studentsform">
 <form class="row g-3 p-3" action="UpdateTeachersAssistant.php" method="POST">
     <div class="col-12">
         <label for="TaID" class="form-label">Ta ID</label>
         <input type="text" class="form-control" name="TaID">
       </div>
     <div class="col-md-6">
...
if(isset($_POST['submit'])){
    ...
    $sql = "UPDATE TeachingAssistant SET Ta_fname = '$taFname', Ta_lname = '$taLname',  Ta_phonenumber = '$taphone', Ta_address = '$taaddress' WHERE TaID = '$taID' ";
