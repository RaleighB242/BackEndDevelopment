...
<section class="container my-2 bg-dark w-50 text-light p-2 studentsform">
 <form class="row g-3 p-3" action="UpdateDinnerMoney.php" method="POST">
 <div class="col-12">
         <label for="DinnerMoneyID" class="form-label">Dinner Money ID</label>
         <input type="text" class="form-control" name="DinnerMoneyID">
       </div>
     <div class="col-12">
         <label for="DinnerMoneyAmount" class="form-label">Dinner Money Amount</label>
         <input type="text" class="form-control" name="DinnerMoneyAmount">
       </div>
       <div class="col-md-6">
         <label for="DinnerMoneyDate" class="form-label">Dinner Money Date</label>
         <input type="date" class="form-control" name="DinnerMoneyDate">
    </div>
...
if(isset($_POST['submit'])){
    $dID= $_POST['DinnerMoneyID'];
    $DA = $_POST['DinnerMoneyAmount'];
    $DD = $_POST['DinnerMoneyDate'];

    $sql = "UPDATE DinnerMoney SET (dinnermoney_amount, dinnermoney_date) 
    WHERE DinnerMoneyID = '$dID' ";
