...
if(isset($_POST['submit'])){
    ...
    $sql = "UPDATE Students SET students_fname='$sFname', students_lname='$sLname', students_address='$saddress' , students_insuranceinfo = '$sinsurance', students_email = '$semail', students_hobby = '$shobby', Gender = '$sgender', ClassesID = '$sclassid', DinnerMoneyID = '$sdinnermoney'  WHERE StudentsID = '$sID' ";
